...
const zh: typeof en = {
  ...
  about: {
    ...
    intro: {
      eyebrow: "Mission", // keep EN — matches the TC frame's own label.
    ...
    howWeWork: {
      eyebrow: "Approach", // keep EN — matches the TC frame.
      heading: "我們的堅持",
      points: [
        {
          title: "以創作者為本",
    ...
    team: {
      eyebrow: "Team", // keep EN — matches the TC frame.
      heading: "認識我們的團隊",
    },
  },
  common: {
