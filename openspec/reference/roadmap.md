...
| 8 | Services part 1 | ✅ Done | `phase-08-services-part-1` | `/[locale]/services` 首圖 + 服務部分, both breakpoints. `ServicesHero` measures Figma's own frame heights exactly (1334px desktop EN, 1528px desktop TC, 880px mobile TC, 824 vs 825 mobile EN). `ServiceCard` got its first real consumer and two Phase 3 errors fell out of it — desktop feature rows stack, they do not pair up (D069). Decisions D066–D073. |
